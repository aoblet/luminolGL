...
namespace Gui{
    ...
    */
	...
	public:
		...
		void addSliderSun(Light::LightHandler & lightHandler, float posBegin=-300, float posEnd=300, float posStep=0.001, float attBegin=0.01, float attEnd=5.0, float attStep=0.001);
